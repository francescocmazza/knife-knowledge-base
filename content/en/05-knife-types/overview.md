...
1. **What kind of work was the knife designed to do?**
2. **What cutting movement does its profile support?**
3. **How much specialization does the user want?**

A knife name describes a tradition and a general purpose, but it does not tell the whole story. Two gyuto can have different lengths, curves, thicknesses and balance. One may feel light and precise; another may feel strong and authoritative. The exact profile of the individual model matters as much as the category name.

## Begin with movement, not with names

Before choosing a knife, observe how the user naturally cuts.

A **rocking cut** keeps part of the edge close to the board while the blade moves in an arc. A curved belly makes this movement easier.

A **push cut** moves the blade forward and down through the food. A flatter edge gives more contact with the board and helps complete the cut cleanly.

A **vertical chop** moves mostly straight down. Tall, flat blades such as nakiri and Chinese chef's knives are comfortable for this style.

A **draw slice** pulls a long section of the edge through the ingredient in one smooth movement. Long, narrow slicers are designed for this purpose.
...
- herbs;
- fruit;
- slicing, chopping and general board work.
...
Many santoku have a relatively flat edge with a gentle curve toward the front. This makes them very effective for push cutting and vertical chopping. Some models support a moderate rocking motion, especially near the tip. Others are too flat for deep rocking.

The santoku is often an excellent recommendation for:
...
This tip gives the bunka a distinctive appearance and practical precision. It is useful for:

- trimming;
- scoring;
- cutting around small joints;
- opening packages of food;
- fine vegetable work;
- detailed tip cuts.

The edge is often relatively straight, making the bunka particularly comfortable for push cutting and chopping. Rocking is possible on some models, but it is generally more limited than on a curved gyuto. If the tip is repeatedly driven into the board during a large rocking motion, it can become damaged.
...
A traditional single-bevel kiritsuke is a specialist Japanese knife associated with advanced professional use. It combines characteristics of long slicing and vegetable knives.
...
Its rectangular appearance can cause confusion. Some people see the shape and assume it is a small cleaver. It is not. A nakiri is usually thin and designed for vegetables, not bones.

The straight edge makes excellent contact with the cutting board. This helps reduce the accordion effect that occurs when pieces remain connected because the edge did not fully reach the board.

The tall blade offers good knuckle clearance and makes it easy to guide the knife against the fingers of the supporting hand. It is also convenient for lifting cut vegetables with the blade face, provided the edge itself is not scraped sideways across the board.

The nakiri is particularly comfortable for:
...
- leafy vegetables;
- herbs;
- repeated chopping and push cuts.
...
It is traditionally single bevel, with a broad main bevel on one side and a flat or slightly hollow reverse side. This brings the cutting edge close to one face of the blade and supports highly precise vegetable work.

The usuba is associated with professional Japanese techniques such as:

- katsuramuki, the continuous peeling of a vegetable into a thin sheet;
- fine decorative cuts;
- extremely thin slices;
- controlled presentation work.
...
A thin cai dao can be used for:
...
- slicing;
- chopping;
- crushing garlic with the blade face;
- moving prepared food with the broad side.

Its height provides excellent knuckle clearance and a large guiding surface. The blade can feel front-heavy to someone used to a Western chef's knife, but experienced users often find it efficient and versatile.
...
The edge is usually stronger and less acute. The extra weight helps the blade move through joints, bones and tough ingredients.

A heavy cleaver is not ideal for delicate slicing. Its strength comes from thickness and mass, which create more resistance in soft foods.
...
Its length allows the user to complete a cut in one smooth draw rather than using repeated sawing motions. The narrow blade creates less contact with the food than a tall chef's knife, reducing drag.
...
Its length supports a single smooth pulling cut. The single-bevel geometry pushes the cut slice away while the flatter reverse side helps leave a clean surface on the remaining fish.

This matters because the cut surface affects both appearance and texture. A rough sawing action can tear delicate flesh. A sharp yanagiba used correctly produces a smooth and controlled result.

The knife requires skill. It tends to steer, is usually handed, and must be sharpened according to its traditional geometry.
...
Flexibility allows the blade to bend around the rib cage or stay close to the skin while filleting. This makes it very different from the rigid slicing action of a sujihiki or yanagiba.
...
- remove heads;
- work through fish collars and joints;
- separate fillets;
- cut suitable fish bones with correct technique;
- perform strong, controlled fish butchery.

Its thickness and weight distinguish it from a yanagiba. The deba is robust for its intended work, but it is not a universal cleaver for large mammal bones. The single-bevel edge can still chip if it is twisted or used carelessly.
...
Its triangular profile and strong heel help the user work around joints, remove meat from the bone and make controlled incisions. It is normally stiffer than a flexible Western boning knife.

The honesuki is designed to work **around** bones rather than chop through large ones. Its point is useful for finding joints and separating connective tissue.
...
A stiff version offers control around beef and pork joints. A flexible version follows fish bones and contours more easily. The pointed tip helps enter tight areas.
...
- cheese;
- trimming meat;
- portioning small ingredients;
- quick tasks when a large knife feels unnecessary.

Longer petty knives can work comfortably on a cutting board. Shorter ones can also handle some in-hand tasks.
...
- cakes;
- pastries;
- soft-skinned tomatoes;
- some delicate foods with a resistant outer surface.
...
A gyuto is a strong choice for someone comfortable with a longer chef's knife.

A santoku suits someone who wants a compact, tall and easy-to-control blade.

A bunka appeals to a user who prefers push cutting and values a precise tip.

A Chinese chef's knife suits someone willing to learn a tall, blade-forward tool with exceptional versatility.
...
- Do you rock, push cut or chop vertically?
- Do you prefer a light or substantial knife?
- Do you need one general knife or a specialist tool?
- Are you comfortable maintaining a delicate edge?
...
Both are general-purpose knives. Their profile and size create different preferences, not strict food boundaries.

### “A Chinese chef's knife is a bone cleaver”

Many Chinese chef's knives are thin slicers and can be damaged by bone chopping.

### “Deba is a universal cleaver”

Deba is designed for fish butchery and appropriate fish bones, not every heavy bone task.

### “Sujihiki cannot cut fish”

Sujihiki can perform very well on fish. Yanagiba offers a more specialized traditional geometry.

### “Petty knives are only for soft vegetables”

Petty knives are versatile small tools for fruit, vegetables, cheese, meat trimming and quick preparation.

### “Every gyuto is ideal for rocking”

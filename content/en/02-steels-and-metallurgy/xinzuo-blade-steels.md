---
title: Xinzuo Blade Steels — Portfolio Guide
status: approved
...
# Xinzuo Blade Steels — Portfolio Guide

Xinzuo does not use one steel for every knife. A fine slicing blade, a versatile chef's knife and a heavy cleaver place different demands on the edge. Cost, maintenance, sharpening, geometry and intended use also matter. Our portfolio therefore ranges from easy-care German stainless steel to very hard powder-metallurgy steels, traditional reactive carbon steel and proprietary or customized Damascus constructions.

This chapter explains the principal steels in the current Xinzuo catalog. It is a portfolio map, not a universal ranking. A steel name describes potential; heat treatment, construction, grinding and edge geometry determine how much of that potential reaches the cutting board.

!!! note "How to read the catalog ratings"
    The catalog compares toughness, edge retention, corrosion resistance and ease of sharpening on an internal five-point scale. Those ratings are useful for comparing the listed Xinzuo options, but they are not standardized laboratory units and should not be compared directly with another manufacturer's stars. Hardness figures are catalog ranges or targets, not a promise that every part of every blade has an identical reading.

## Portfolio at a glance

| Steel or catalog construction | Catalog hardness | Character in practical use | Main advantage | Main compromise |
|---|---:|---|---|---|
...
M390 is valuable where a long-lasting working edge and easy corrosion care are priorities. Its hard carbide population resists ordinary abrasives, so effective sharpening equipment and patience matter. It should be sold on the total package—steel, heat treatment and geometry—not on the M390 name alone.
...
This is the most forgiving end of the portfolio map. It is suitable for users who prefer uncomplicated care, quick sharpening and a larger margin for everyday technique. It will normally need edge maintenance sooner than a high-hardness powder steel, but that maintenance is faster and more accessible.
...
*Source note: steel names, origins, catalog hardness ranges and portfolio descriptions on this page are based on the 2025 Xinzuo catalog. Series specifications should be rechecked against current authorized product data before making availability or model-level claims.*
